...
router.put("/update", async (req, res) => {
  ...
  try {
    ...
    // Aggiornamento degli altri campi dell'acquisto
    ...
    purchase.status = "In Approvazione" || purchase.status;
    ...
    // Se ci sono prodotti, aggiorna anche le righe dell'acquisto
    if (products) {
