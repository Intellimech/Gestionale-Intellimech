  ...
  const fullnavigation = [
    ...
    { 
      ...
      options: [
        ...
        { name: 'Macro Categorie', href: '/app/category', icon: 'TagIcon', current: false},
        { name: 'Categorie', href: '/app/subcategory', icon: 'SwatchIcon', current: false},
        { name: 'Sotto Categorie', href: '/app/subsubcategory', icon: 'TagIcon', current: false},
        { name: 'Aree Tecniche', href: '/app/technicalarea', icon: 'WrenchScrewdriverIcon', current: false},
        { name: 'Location', href: '/app/locations', icon: 'HomeIcon', current: false},
