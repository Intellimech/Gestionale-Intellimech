  ...
  return (
    <form name="createoffer" className="max-w-7xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        {/* Tasks Section */}
        <div>
          <h3 className="text-lg font-medium leading-6 text-gray-900 mb-4">Tasks</h3>
          ...
          <button
            type="button"
            onClick={() => addTask()}
            className="mt-3 rounded-md bg-[#7fb7d4] px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#6ca7c4]"
          >
            Aggiungi Task
          </button>
        </div>
